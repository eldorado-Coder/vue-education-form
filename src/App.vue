    ...
    <div class="overall-wrapper">
        <div class="top-wrapper program">
            <div class="mw">
                        ...
                        <div class="profile-picture-container" id="profile-picture">
                            <div class="mw ">
                                <div class="profile-picture ">
                                    <img width="112" height="112" src="" alt="Flat6Labs Amman Seed Program - Cycle 2">    
                                </div>
                            </div>
                        </div>
                ...
                <div id="cover-wrapper" class="cover-wrapper">
                    <div class="cover" id="cover" style="" data-full-cover-url="https://www.f6s.com/content-resource/media/1373287.jpg"></div>
        ...
        <div class="mw">
            <div id="csProfileMenu" class="program-menu-wrapper has-barlabel">
                <div id="csMenuWrapper" class="h-bar no-padding neo-menu-wrapper color-body">
                        ...
                        <div class="permanent-content" style="width: 100%;">
                            <div class="team-blip-wrapper v-padding">
                                <div class="stacked-thumbs thumbs">
                                    <img class="profile i48 u" width="64" height="64" src="" srcset="">
                                </div>
                                <div class="names">
                                    <span class="blk t b16">
                                        Mohammed
                                    </span>
                                </div>
                            </div>
        ...
        <div class="main-wrapper-t">
            <div class="main-content" id="csProfileMainContent">
                            ...
                            <div class="sidebar-block">
                                ...
                                <div class=" overview-blocks">
                                    <div class="location-wrapper t b16">
                                        <span id="csInlineLocation" class="input size-b16 color-none t-main ">
                                            <span class="inner typable">
                                                <span class="attachment" style="width: 13px; height: 26px"><i class="fa fa-map-marker"></i></span>
                                    ...
                                    <div class="profile-links-wrapper t b16">
                                        <div class="cover-links link-icon-container ">
                                            <a class="link-icon link-facebook fa-facebook-square" title="Flat6Labs Amman Seed Program - Cycle 2's Facebook page" data-ga="{&quot;section&quot;:&quot;&quot;,&quot;feature&quot;:&quot;Media Link&quot;}" target="_blank" rel="noopener noreferrer nofollow" href="https://www.facebook.com/flat6labs"></a>
                                            <a class="link-icon link-twitter fa-twitter-square" title="Flat6Labs Amman Seed Program - Cycle 2's Twitter page" data-ga="{&quot;section&quot;:&quot;&quot;,&quot;feature&quot;:&quot;Media Link&quot;}" target="_blank" rel="noopener noreferrer nofollow" href="https://twitter.com/@flat6labs"></a>
                                            <a class="link-icon link-linkedin fa-linkedin-square" title="Flat6Labs Amman Seed Program - Cycle 2's Linkedin page" data-ga="{&quot;section&quot;:&quot;&quot;,&quot;feature&quot;:&quot;Media Link&quot;}" target="_blank" rel="noopener noreferrer nofollow" href="https://www.linkedin.com/company/flat6labs"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="mainarea" id="csBlockLoader">
                    <div class="transition-overlay t60" id="csBlockLoaderTransition"></div>
                    <div class="tile ">
                        <div class="tile-banner ash-blue">
                            <div>Questions</div>
                            <div class="filler"></div>
                        </div>
                        <form name="csAppForm" data-ui="application-form" @submit.prevent="onFormSubmit">
                            <div class="form-questions form-emphasis-larger">
                                <div class="application-text-section">
                                    <p class="t text-section-title ">Section 1: Personal Overview</p>
                                </div>
                                <ol style="counter-reset: questions 0;">
                                        ...
                                        <div class="styles--3ok0- styles--3EPF6 styles--3IYUq">
                                            <label class="styles--3aPac">
                                                <span class="styles--1-9tY">
                                                    <span class="styles--2TdGW styles--3Y34Z styles--33eUF">
                                                        <strong class="styles--2kqW6">*</strong>
                                                    </span>
                                                    <span id="firstname_label" class="styles--2TdGW  styles--3da4O">
                                                        <strong class="styles--2kqW6">First name</strong>
                                                    </span>
                                                </span>
                                                <div class="styles--1tBNa">
                                                    <div class="styles--3qHIU">
                                                        <input aria-required="true" id="firstname" maxlength="127" name="firstname" required="" aria-labelledby="firstname_label" type="text" class="styles--2e9Cp" value="" v-model="user.firstname">
                                                    </div>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="styles--3ok0- styles--2oFcR styles--3IYUq">
                                            <label class="styles--3aPac">
                                                <span class="styles--1-9tY">
                                                    ...
                                                    <span id="lastname_label" class="styles--2TdGW  styles--3da4O">
                                                        <strong class="styles--2kqW6">Last name</strong>
                                                    </span>
                                                </span>
                                                <div class="styles--1tBNa">
                                                    <div class="styles--3qHIU">
                                                        <input aria-required="true" id="lastname" maxlength="127" data-ui="lastname" name="lastname" required="" aria-labelledby="lastname_label" type="text" class="styles--2e9Cp " v-model="user.lastname" value="">
                                                    </div> 
                                                </div>
                                            </label>
                                        </div>
                                        ...
                                        <div class="styles--3ok0- styles--3IYUq">
                                            <label class="styles--3aPac">
                                                <span class="styles--1-9tY">
                                                    ...
                                                    <span id="email_label" class="styles--2TdGW  styles--3da4O">
                                                        <strong class="styles--2kqW6">
                                                            <font style="vertical-align: inherit;">
                                                ...
                                                <div class="styles--1tBNa">
                                                    <div class="styles--3qHIU">
                                                        <input aria-required="true" id="email" maxlength="255" data-ui="email" name="email" required="" aria-labelledby="email_label" type="email" class="styles--2e9Cp " v-model="user.email" value="">
                                                    </div>
                                                </div>
                                            </label>
                                        </div>
                                    ...
                                    <li class="application-field">
                                        <div class="styles--3ok0- styles--3aPac styles--3IYUq">
                                            <span class="styles--1-9tY">
                                                <span id="address_label" class="styles--2TdGW  styles--3da4O">
                                                    <strong class="styles--2kqW6">Address</strong>
                                                    <span class="styles--3VVrr styles--19x-w styles--1LuHk"> (Optional)</span>
                                                </span>
                                            </span>
                                            <div class="styles--1tBNa">
                                              <div class="styles--3qHIU"><input aria-required="true" id="address" maxlength="255" data-ui="address" name="address" required="required" aria-labelledby="address_label" type="address" value="" class="styles--2e9Cp" v-model="user.address">
                                              </div>
                                            </div>
                                        </div>
                                    </li>
                              ...
                              <div class="styles--2uKQq">
                                  <div class="styles--ArVfo">
                                    <div class="styles--2Z5fi">
                                      ...
                                      <button data-ui="add-section" aria-label="Add Education" class="button--2de5X button--32xRL secondary--2ySVn" :disabled="!showEdu"  @click="showEducation" :aria-disabled="!showEdu">
                                        + Add
                                      </button>
                                    </div>
                                    <ul>
                                        ...
                                        <div data-ui="editor">
                                          <div class="styles--3LPHM styles--3IYUq">
                                            <label class="styles--3aPac">
                                              ...
                                              <div class="styles--1tBNa">
                                                <div class="styles--3qHIU">
                                                  <input aria-required="true" maxlength="255" data-hj-whitelist="true"  required=""  type="text" class="styles--2e9Cp " value="">
                                                </div>
                                              </div>
                                            </label>
                                          </div>
                                          <div class="styles--3LPHM styles--3IYUq">
                                            <label class="styles--3aPac">
                                              <span class="styles--1-9tY">
                                                <span id="field_of_study_label" class="styles--2TdGW  styles--3da4O">
                                                  <strong class="styles--2kqW6">
                                              ...
                                              <div class="styles--1tBNa">
                                                <div class="styles--3qHIU">
                                                  <input aria-required="true" maxlength="255" data-hj-whitelist="true"  type="text" class="styles--2e9Cp " value="">
                                                </div>
                                              </div>
                                            </label>
                                          </div>
                                          ...
                                          <div class="styles--3LPHM styles--2RhEK styles--3IYUq">
                                            <label class="styles--3aPac">
                                              <span class="styles--1-9tY">
                                                <span id="field_of_study_label" class="styles--2TdGW  styles--3da4O">
                                                  <strong class="styles--2kqW6">
                                                  ...
                                                  <div class="styles--1tBNa">
                                                    <div class="styles--3qHIU">
                                                      <div class="up-dropdown-icon up-icon sm">
                                                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" viewBox="0 0 14 14" role="img"><path d="M.37 5l5.75 5.92a1.23 1.23 0 001.78 0L13.64 5a1.31 1.31 0 000-1.83 1.27 1.27 0 00-.86-.37H1.25A1.27 1.27 0 000 4a1.28 1.28 0 00.37 1z"></path></svg>
                                                      </div>
                                                      <select aria-required="true" maxlength="255" data-hj-whitelist="true" type="text" 
                                                      class="styles--2e9Cp ">
                                          ...
                                          <div class="styles--3LPHM styles--3-0gZ styles--3IYUq">
                                            <label class="styles--3aPac">
                                              <span class="styles--1-9tY">
                                                <span id="field_of_study_label" class="styles--2TdGW  styles--3da4O">
                                                  <strong class="styles--2kqW6">
                                          ...
                                          <div class="styles--3wmD1">
                                            <button data-ui="save-section" class="button--2de5X button--14TuV primary--25RCR ">Save</button>
                                            <button class="button--2de5X button--14TuV tertiary--1L6hu styles--1hvTZ" data-ui="cancel-section" @click="showEducation">Cancel</button>
                                          </div>
                                        </div>
                                      </li>
                                      <li class="styles--2SPgS">
                                        <div data-ui="group">
                                          ...
                                          <div class="styles--Jt82u">
                                            <div>
                                              <a data-ui="edit-section" title="Edit" aria-label="Edit vcccccccccc" class="styles--jQpn9 " tabindex="0" role="button">
                                                <svg><use xlink:href="#pencil16"></use></svg></a>
                                              <a data-ui="remove-section" title="Delete" aria-label="Delete vcccccccccc" class="styles--jQpn9 " tabindex="0" role="button"><svg><use xlink:href="#trash16"></use></svg></a>
                                            </div>
                                          </div>
                                        </div>
                                      </li>
                                  ...
                                  <div class="styles--ArVfo">
                                    <div class="styles--2Z5fi">
                                      ...
                                      <button data-ui="add-section" aria-label="Add Experience" class="button--2de5X button--32xRL secondary--2ySVn" :disabled="!showExp"  @click="showExperience" :aria-disabled="!showExp">
                                        + Add
                                      </button>
                                    </div>
                                    <ul>
                                      <li v-if="!showExp" class="styles--39Oec styles--1-mi6">
                                        <div data-ui="editor">
                                          ...
                                          <div class="styles--3wmD1">
                                            <button data-ui="save-section" class="button--2de5X button--14TuV primary--25RCR ">Save</button>
                                            <button class="button--2de5X button--14TuV tertiary--1L6hu styles--1hvTZ" data-ui="cancel-section" @click="showExperience">Cancel</button>
                                          </div>
                                        </div>
                                      </li>
                                      <li class="styles--2SPgS">
                            ...
                            <div class="form-submitter" style="max-width: 600px">
                              <button @submit.prevent="onFormSubmit" type="submit" id="csApplicationSubmit" class="component button cs-application-submit nopadding connect-application full-width color-green size-large">
                                <span class="caption">
                                    <span class="title">Connect with <br>Omar, Rasha &amp; Rawan</span>
                                </span>
                              </button>
                            </div>
                        </form>
...
.styles--1tBNa textarea, .styles--1tBNa input,.styles--1tBNa textarea, .styles--1tBNa select {
    font-stretch: normal;
    font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Ubuntu, "Helvetica Neue", sans-serif;
    font-size: 14px;
    text-rendering: geometricPrecision;
...
.styles--3ok0- input,.styles--3ok0- select {
    padding: 8px;
}
.styles--2e9Cp {
    margin: 0;
...
.h-bar:not(.left-align), .h-bar:not(.left-align) .h-bar-content {
    -webkit-align-items: center;
    -ms-align-items: center;
    align-items: center;
}
.h-bar.color-body, .h-bar.color-body .fade-sides {
...
.sidebar-content>div, .sidebar>div:not(.sidebar-content) {
    margin: 25px 0;
    color: #333;
}
.b18 {
...
.tile .tile-banner, .tile .tile-bleeder.section-info {
    padding: 20px 24px;
}
...
.input.full-width, .input.full-width>.inner {
    width: 100%;
}
.full-width {
    -moz-box-sizing: border-box;
...
.dropdown ul.elements>li:not(.disabled), ul.listable>li:not(.disabled) {
    cursor: pointer;
}
.dropdown ul.elements>li, ul.listable>li {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: -ms-flex;
    display: flex;
...
.dropdown ul.elements>li>.tick, ul.listable>li>.tick {
...
.dropdown ul.elements:not(.allow-wrap)>li>.entry, ul.listable:not(.allow-wrap)>li>.entry {
    text-overflow: clip;
    overflow: hidden;
    white-space: nowrap;
}
.dropdown ul.elements>li>.entry, ul.listable>li>.entry {
    -webkit-align-self: center;
    -ms-align-self: center;
    align-self: center;
    width: 100%;
...
.button:not(.bordered):not(.no-shadow):not(.disabled)>.caption, .button:not(.bordered):not(.no-shadow):not(.disabled)>.caption:active {
    box-shadow: 0 0 4px 0 rgb(0 0 0 / 4%), 0 1px 3px 0 rgb(0 0 0 / 18%);
}
.button.color-accent>.caption, .button.color-green>.caption {
    background-color: #3b7dff;
    border-color: #3b7dff;
}
@media (min-width: 768px)
.button.size-large>.caption, .size-large>.button>.caption {
    padding: 12px 15px;
}
...
.connect-application>.caption, .connect-application>.caption:active {
    box-shadow: 0 4px 6px 0 rgba(0,0,0,.17),0 1px 2px 0 rgba(0,0,0,.1)!important;
}
...
.button.size-large>.caption>.title, .size-large>.button>.caption>.title {
    font-weight: 600;
}
...
.cs-button-color-green:hover span.caption{color:#fff;border-color:#113d06}
.styles--19x-w {
  color: #88929e;
}
.styles--3VVrr {
...
.form-emphasis-larger{padding-bottom: 24px;}
.styles--2itFq {
  padding-bottom: 24px;
}
.styles--2oDxC {
...
.styles--1-mi6 .styles--3LPHM.styles--2RhEK, .styles--1-mi6 .styles--3LPHM.styles--3-0gZ{
  vertical-align: top;
}
.styles--1-mi6 .styles--3LPHM.styles--2RhEK, .styles--1-mi6 .styles--3LPHM.styles--3-0gZ, .styles--1-mi6 .styles--3LPHM.styles--TBUfB{
  box-sizing: border-box;
  max-width: 48%;
  float: left;
}
